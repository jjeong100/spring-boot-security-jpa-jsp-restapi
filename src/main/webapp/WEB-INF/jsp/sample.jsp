...
// 		        });
                ...
                $('#btnSearch').click(function() {
	                $.ajax({
	                    url : "<c:url value='/updateMaterialAdjustment.do'/>",
	                    type: 'POST',
	                    data: {"matinSeq":$(this).data("matinSeq"),"inCnt":$(this).data("inCnt"),"matoutSeq":$(this).data("matoutSeq"),"outCnt":$(this).data("outCnt")},
